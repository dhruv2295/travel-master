...
public class DesActivity extends AppCompatActivity {
    ...
    TextView name,desc,venue,categories;
    TextView rest,hotel,shop,att;

    ButtonRectangle get_direction;
    ...
    //    getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        ...
        OriginLat=0.0;
        OriginLong=0.0;
        GPSTracker tracker = new GPSTracker(DesActivity.this);
    ...
    private class DownloadWebPageTask2 extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... urls) {
            String URL;
            String us;
           // SharedPreferences s = PreferenceManager.getDefaultSharedPreferences(DesActivity.this);
          //  us = s.getString("id",null);
            URL = "http://csinsit.org/prabhakar/aloogobhi/get-attraction-info.php?eventid="+id;
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                if(ob.has("restraunt"))
                {
                    ...
                    adapter = new CustomList2(DesActivity.this, restaurants1);
                    lvRest.setAdapter(adapter);
                    Log.d("Weel hotel is here:","heee");
                }
                else
                {
                ...
                if(ob.has("shopping")){
                    ...
                    CustomList_shop adapter = new CustomList_shop(DesActivity.this, restaurants2);
                    lvShop.setAdapter(adapter);
                ...
                if(ob.has("art_gallery")){
                    ...
                    CustomList_att adapter = new CustomList_att(DesActivity.this, restaurants3);
                    lvTour.setAdapter(adapter);
                }else{
                    pb3.setVisibility(View.GONE);
                ...
                if(ob.has("hotels")){
                    ...
                    CustomList_hot adapter = new CustomList_hot(DesActivity.this, restaurants4);
                    lvHotels.setAdapter(adapter);
                }else{
                    pb4.setVisibility(View.GONE);
                    hotel.setVisibility(View.GONE);
                    Log.e("cannot find hotel data", " " +id);
                    lvRest.setVisibility(View.GONE);
                }
